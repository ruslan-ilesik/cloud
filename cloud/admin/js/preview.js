...
function make_preview(e){
    ...
    if (type == 'image'){
        ...
        video.src = '/files'+btoa(unescape(encodeURIComponent(default_path+filename)))
        ...
        audio.src = '/files'+btoa(unescape(encodeURIComponent(default_path+filename)))
        ...
        emb.setAttribute('src','/files'+btoa(unescape(encodeURIComponent(default_path+filename))))
